...
public class AiBackgroundServiceOLD : BackgroundService
{
    ...
    private readonly ILogger<AiBackgroundServiceOLD> _logger;
    ...
    public AiBackgroundServiceOLD(AudioConverterFactory audioConverter, ILogger<AiBackgroundServiceOLD> logger, IConfiguration configuration, WhisperFasterDockerService whisperFasterService, WhisperNetService whisperNet, WhisperCppService whisperCpp, KoboldService KoboldService, IDbContextFactory<SqliteDbContext> sqliteDbContext, IDbContextFactory dbContextFactory, IHubContext<TodoHub> hubContext, IOptions<WhisperCppOptions> options, AudioConverterFactory audioConverterFactory)
    {
        _logger = logger;
